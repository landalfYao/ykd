<template>
    <div>
        <h2><el-button @click="$router.go(-1)" size="small" icon="el-icon-arrow-left" circle ></el-button> 操作列表</h2>
...
export default {
  ...
  methods: {
    ...
    wanc(){
      this.$http.post(this.com.JAVA_API+'placeOpertion/complete',{
        id:this.selectionId
      }, { emulateJSON: true })
      .then (res => {
          if (res.data.code) {
    ...
    getDataList() {
      this.$http
        .post(
          this.com.JAVA_API + "placeOpertion/findbyplace2",
