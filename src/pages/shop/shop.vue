<template>
  <div>
    ...
    <div class="panel-between">
      ...
      <div>
        <span>条数：</span>
        <InputNumber :step="1" value="1" @on-blur="changeSize" style="width:60px"></InputNumber>
      </div>
    </div>
    ...
    >
      ...
      <el-table-column prop="name" label="基地名称"></el-table-column>
      ...
      >
        <template slot-scope="scope">
          <el-tag
            ...
            disable-transitions
          >{{scope.row.status == 0 ? '上线':'下线'}}</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="title" label="公告"></el-table-column>
      <el-table-column prop="address" label="地址"></el-table-column>
      <el-table-column prop="core" label="评分"></el-table-column>
        ...
        <template slot-scope="scope">
          <el-dropdown trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item>
                <div style="width:100px" @click="navTo('/shop_edit',scope.row)">编辑基地</div>
              </el-dropdown-item>
              <el-dropdown-item>
                <div style="width:100px" @click="navTo2('/goods_cate',scope.row.id)">商品分类</div>
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </template>
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      this.$http
        .post(this.com.JAVA_API + "shop/find", this.query, {
          emulateJSON: true
        })
        .then(res => {
          if (res.data.code) {
