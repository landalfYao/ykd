<template>
    <div>
        ...
        <el-table :data="data" style="width: 100%;margin-top:15px" @selection-change="handleSelectionChange">
            ...
            <el-table-column  prop="full" label="满" >  </el-table-column>
            <el-table-column  prop="reduce" label="减" >  </el-table-column>
...
this.$router.push({path:path,query:{id:id}})
    ...
    doupdate(data, url) {
      this.$http.post(this.com.JAVA_API + url,data,{ emulateJSON:true } ).then(res => {
        if (res.data.code) {
