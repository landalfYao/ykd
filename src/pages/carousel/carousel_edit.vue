<template>
    <div>
        <h2><el-button v-if="formData.Id" @click="navTo('/carousel')" size="small" icon="el-icon-arrow-left" circle ></el-button> 广告编辑</h2>
        ...
        <div class="panel-start">
            ...
            <div style="width:400px;padding-top:20px">
                <Form :model="formData" label-position="top">
                    ...
                    <FormItem label="广告商">
                        <Input v-model="formData.company" placeholder="广告商" style="width:400px" />
                    </FormItem>
                    <FormItem label="电话">
                        <Input v-model="formData.phone" placeholder="电话" style="width:400px" />
                    </FormItem>
                    <FormItem label="开始时间">
                        <Input v-model="formData.start_time" placeholder="开始时间" :disabled="formData.Id ? true:false" style="width:400px" />
                    </FormItem>
                    <FormItem label="结束时间">
                        <Input v-model="formData.end_time" placeholder="结束时间" style="width:400px" />
                    </FormItem>
                    <FormItem label="备注">
                    ...
                    <FormItem label="富文本">
                        <el-button @click="sdVisible = true">查看富文本</el-button>
                         <span>{{formData.content_id ? '已选':''}}</span>
                    </FormItem>
                    <FormItem label="上架提交">
...
export default {
  ...
  methods: {
    ...
    submitTichtext() {
      ...
      this.$http
        .post(this.com.NODE_API + "carousel/" + url, {
