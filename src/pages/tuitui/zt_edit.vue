<template>
    <div>
        <h2><el-button v-if="formData.Id" @click="navTo('/carousel')" size="small" icon="el-icon-arrow-left" circle ></el-button> 农产品推荐编辑</h2>
        ...
        <div class="panel-start">
            ...
            <div style="width:400px;padding-top:20px">
                <Form :model="formData" label-position="top">
                    ...
                    <FormItem label="标题">
                        <Input v-model="formData.name" placeholder="标题" style="width:400px" />
                    </FormItem>
...
export default {
  ...
  methods: {
    ...
    submitTichtext() {
      ...
      this.$http
        .post(this.com.NODE_API + "zttype/" + url, {
