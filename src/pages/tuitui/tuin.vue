    ...
    <div>
        ...
        <div class="panel-between">
            <ButtonGroup >
                ...
                <Button @click="navTo2('/tuin_edit')">新增农场推荐</Button>
            </ButtonGroup>
            <div>
                <span>条数：</span>
        ...
        <el-table :data="data" style="width: 100%;margin-top:15px" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作"> 
                <template slot-scope="scope">
                    <el-button type="text" @click="navTo('/tui_edit',scope.row)">修改</el-button>
                </template>
            </el-table-column>
        </el-table>
...
export default {
  ...
  mounted() {
    that = this;
    this.query.wheres+=this.$route.query.id
    this.getDataList();
